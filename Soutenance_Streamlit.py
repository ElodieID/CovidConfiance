...
@st.cache(allow_output_mutation=True)
def load_data3():
    data3_AT = pd.read_csv('ndf_AT.csv',sep = ";",index_col=0, encoding='utf8')
    data3_AU = pd.read_csv('ndf_AU.csv',sep = ";",index_col=0, encoding='utf8')
    data3_BR = pd.read_csv('ndf_BR.csv',sep = ";",index_col=0, encoding='utf8')
    data3_DE = pd.read_csv('ndf_DE.csv',sep = ";",index_col=0, encoding='utf8')
    data3_FR = pd.read_csv('ndf_FR.csv',sep = ";",index_col=0, encoding='utf8')
    data3_IT = pd.read_csv('ndf_IT.csv',sep = ";",index_col=0, encoding='utf8')
    data3_NZ = pd.read_csv('ndf_NZ.csv',sep = ";",index_col=0, encoding='utf8')
    data3_PL = pd.read_csv('ndf_PL.csv',sep = ";",index_col=0, encoding='utf8')
    data3_SE = pd.read_csv('ndf_SE.csv',sep = ";",index_col=0, encoding='utf8')
    data3_UK = pd.read_csv('ndf_UK.csv',sep = ";",index_col=0, encoding='utf8')
    data3_US = pd.read_csv('ndf_US.csv',sep = ";",index_col=0, encoding='utf8')
...
@st.cache(allow_output_mutation=True)
def load_data1():
    data1_AT = pd.read_csv('df_AT.csv',sep = ";",index_col=0, encoding='utf8')
    data1_AU = pd.read_csv('df_AU.csv',sep = ";",index_col=0, encoding='utf8')
    data1_BR = pd.read_csv('df_BR.csv',sep = ";",index_col=0, encoding='utf8')
    data1_DE = pd.read_csv('df_DE.csv',sep = ";",index_col=0, encoding='utf8')
    data1_FR = pd.read_csv('df_FR.csv',sep = ";",index_col=0, encoding='utf8')
    data1_IT = pd.read_csv('df_IT.csv',sep = ";",index_col=0, encoding='utf8')
    data1_NZ = pd.read_csv('df_NZ.csv',sep = ";",index_col=0, encoding='utf8')
    data1_PL = pd.read_csv('df_PL.csv',sep = ";",index_col=0, encoding='utf8')
    data1_SE = pd.read_csv('df_SE.csv',sep = ";",index_col=0, encoding='utf8')
    data1_UK = pd.read_csv('df_UK.csv',sep = ";",index_col=0, encoding='utf8')
    data1_US = pd.read_csv('df_US.csv',sep = ";",index_col=0, encoding='utf8')
